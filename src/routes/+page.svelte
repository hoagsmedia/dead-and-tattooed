...
<div class="my-4 w-1/2">
	<a
		class="transition ease-in-out btn hover:drop-shadow-lg hover:scale-105 text-white w-full font-semibold py-3 px-6 rounded-lg"
...
<article class="prose text-center">
	<p>Follow along on Instagram to see my latest work and behind-the-scenes!</p>
</article>
